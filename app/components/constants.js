...
var INVESTOR_PROFILES=[
  ...
  {id:"sleep",name:"Nick Sleep",fund:"Nomad Investment Partnership",
   ...
   thesisPrompt:"How does this business get better for customers as it gets bigger? Where are the scale economies and are they being shared?",
  ...
  {id:"munger",name:"Charlie Munger",fund:"Berkshire Hathaway",
   ...
   thesisPrompt:"Invert: why would this business fail in 10 years? Now make the case for why it won't.",
  ...
  {id:"lynch",name:"Peter Lynch",fund:"Magellan Fund",
   ...
   thesisPrompt:"Can you explain this business in two sentences? What category is it — fast grower, stalwart, asset play, turnaround — and what's the PEG?",
  ...
  {id:"akre",name:"Chuck Akre",fund:"Akre Capital Management",
   ...
   thesisPrompt:"Assess the three legs: (1) Is this an extraordinary business with durable high ROE? (2) Is management exceptional and aligned? (3) Is there a long reinvestment runway at high rates?",
